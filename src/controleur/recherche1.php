...
if (isset($_GET['nom']) && !empty($_GET['nom'])) {
    ...
    if ($eleves) {
        ...
        echo "<th style='border: 1px solid #090909; padding: 8px; text-align: left;'>Role</th>";
        echo "<th style='border: 1px solid #090909; padding: 8px; text-align: left;'>Secteur d'activité</th>";
        echo "</tr>";
        echo "</thead>";
        echo "<tbody>";
        foreach ($eleves as $eleve) {
            ...
            echo "<td style='border: 1px solid #090909; padding: 8px;'>" . htmlspecialchars($eleve['role'] ?? 'N/A') . "</td>";
            echo "<td style='border: 1px solid #090909; padding: 8px;'>" . htmlspecialchars($eleve['secteur_activite'] ?? 'N/A') . "</td>";
            echo "</tr>";
        }
        echo "</tbody>";
        echo "</table>";
